 ...
 */
public class CanvasTreeNodeTypeOperator extends CanvasTreeNode
{
	private final Sign symbol;

	CanvasTreeNodeTypeOperator(double x, double y, double width, double height,
	...
	MathSymbolBuilder.Sign getSymbol()
	{
		return symbol;
	}
}
